...
@interface MentionsViewController () <UITableViewDataSource, UITableViewDelegate, ComposeViewControllerDelegate, TweetCellDelegate>
...
- (void)viewDidLoad {
    ...
    __weak MentionsViewController *weakSelf = self;
